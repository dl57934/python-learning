...
browser.get("http://hoony-gunputer.tistory.com/manage/dashboard/visitors.json")

print(browser.find_element_by_css_selector("#mArticle > div > div.blog_top > div:nth-child(1) > div > dl.count_visitor.count_all > dd")
